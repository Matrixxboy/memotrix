...
| `embeddings.py`              | _(none)_                  | Callers pass an explicit model; dimension comes from the model |
...
| `hnsw_index.py` _(dev/eval)_ | `M`                       | 16                                                             | HNSW graph connectivity                                  |
| `hnsw_index.py` _(dev/eval)_ | `ef_construction`         | 200                                                            | HNSW build-time search depth                             |
| `hnsw_index.py` _(dev/eval)_ | `ef`                      | 50                                                             | HNSW query-time search depth                             |
...
| **Reranker** | `cross-encoder/ms-marco-MiniLM-L-6-v2` *(conditional skip for agent latency)* |
